      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        {candidates.map(
          (item) => (
            <div
              key={item.id}
              className="bg-white rounded-[30px] shadow-2xl overflow-hidden border border-gray-200 hover:shadow-3xl transition"
            >
              ...
              <div className="p-5 md:p-8">
                ...
                <button
                  ...
                  className="w-full bg-red-700 hover:bg-red-800 active:scale-95 text-white py-4 md:py-5 rounded-2xl text-lg md:text-xl font-bold transition duration-200"
                >
                  Pilih Paslon
                </button>
